...
# scale.py — reconstructed from provided bytecode (Python 3.11a7e)
...
SCALE_NAMES = [None] + [
    {s[1]: s[0] for s in Live.Song.get_all_scales_ordered()}.get(intervals, None)
    for intervals in FIRMWARE_SCALES
]
del FIRMWARE_SCALES
